...
# Save to file
with open('generated_student_kmeans_data_10.json', 'w') as f:
    json.dump(student_data, f, indent=2)

print(f"Successfully generated {req_num_students} students records in 'generated_student_data_10k.json'")